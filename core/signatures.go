...
var Signatures = []Signature{
  ...
  PatternSignature{
    part:        PartPath,
    match:       regexp.MustCompile(`ApiKey`),
    description: "Contains word: ApiKey",
    comment:     "",
  },
  PatternSignature{
    part:        PartPath,
    match:       regexp.MustCompile(`db`),
    description: "Contains word: db",
    comment:     "",
  },
  PatternSignature{
    part:        PartPath,
    match:       regexp.MustCompile(`_key`),
    description: "Contains word: _key",
    comment:     "",
  },
  PatternSignature{
    part:        PartPath,
